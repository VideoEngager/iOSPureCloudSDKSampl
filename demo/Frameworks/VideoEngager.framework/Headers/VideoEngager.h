...
@interface VDEPureCloudParameters : NSObject
 ...
 *  @param externalServiceName Optional service name. If not provided defaults to 'request-chat'
 *  @param authorizationValue Optional Authorization header value. If not provided no authorization will be provided
 *  @param completionHandler A callback called once the join process has been completed
 */
- (void) joinWithAgentPath: (NSString*) agentPath
